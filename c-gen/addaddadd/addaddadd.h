...
// two build merge into one
void func_1(int *var2, int *var1, int *var0, int *var9)
{
    for (int var15 = 0; var15 < 100; var15++)
    {
        *(&var9[var15]) = (var0[var15] + var1[var15] + var2[var15]);
    }
}

void func_2(int *var2, int *var1, int *var0, int *var9, int *var10)
{
    for (int var16 = 0; var16 < 100; var16++)
    {
        *(&var10[var16]) = (var0[var16] + var1[var16]);
